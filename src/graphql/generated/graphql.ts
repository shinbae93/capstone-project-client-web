...
export type LoginMutation = {
  __typename?: 'Mutation'
  login: { __typename?: 'LoginOutput'; accessToken: string; refreshToken: string }
}
  ...
  course: {
    ...
    classes?: Array<{
      ...
      schedule: Array<{
        __typename?: 'ScheduleTime'
        dayOfWeek: number
        startTime: { __typename?: 'LessonTime'; hour: number; minute: number }
        endTime: { __typename?: 'LessonTime'; hour: number; minute: number }
      }>
    }> | null
  }
}
...
export type CoursesQuery = {
  ...
  courses: {
    ...
    items: Array<{
      ...
      classes?: Array<{ __typename?: 'Class'; occupiedSlots: number }> | null
    }>
  }
}
...
export type PublishCourseMutation = {
  __typename?: 'Mutation'
  publishCourse: { __typename?: 'Course'; id: string }
}
...
export type UpdateCourseMutation = {
  __typename?: 'Mutation'
  updateCourse: { __typename?: 'Course'; id: string }
}
...
export type CreateEnrolmentMutation = {
  __typename?: 'Mutation'
  createEnrolment: { __typename?: 'Enrolment'; id: string; isFinished: boolean }
}
...
export type SubjectsQuery = {
  __typename?: 'Query'
  subjects: Array<{ __typename?: 'Subject'; id: string; name: string }>
}
...
export function usePublishCourseMutation(
  baseOptions?: Apollo.MutationHookOptions<PublishCourseMutation, PublishCourseMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<PublishCourseMutation, PublishCourseMutationVariables>(
    PublishCourseDocument,
    options
  )
}
...
`
export type CreateEnrolmentMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateEnrolmentMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<CreateEnrolmentMutation, CreateEnrolmentMutationVariables>(
...
export type CreateEnrolmentMutationOptions = Apollo.BaseMutationOptions<
  CreateEnrolmentMutation,
  CreateEnrolmentMutationVariables
>
 ...
 * });
 */
export function useEnrolmentsQuery(
  baseOptions?: Apollo.QueryHookOptions<EnrolmentsQuery, EnrolmentsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<EnrolmentsQuery, EnrolmentsQueryVariables>(EnrolmentsDocument, options)
}
export function useEnrolmentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<EnrolmentsQuery, EnrolmentsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
